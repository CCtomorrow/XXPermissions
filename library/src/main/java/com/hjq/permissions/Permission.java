...
public final class Permission {
     ...
     */
    static int getPermissionFromAndroidVersion(String permission) {
     ...
     */
    static int getSpecialPermissionFromAndroidVersion(String permission) {
     ...
     */
    static int getDangerPermissionFromAndroidVersion(String permission) {
     ...
     * 判断权限是否必须要在清单文件中注册
     */
    static boolean isMustRegisterInManifestFile(String permission) {
